...
/**
 Mock Client for the IotData service that by default always throws from its methods.
 */
public struct ThrowingIotDataClient: IotDataClientProtocol {
