...
public extension GetAccessKeyInfoRequest {
     ...
     */
    public static let __default: SecurityTokenModel.GetAccessKeyInfoRequest = {
...
public extension GetAccessKeyInfoResponse {
     ...
     */
    public static let __default: SecurityTokenModel.GetAccessKeyInfoResponse = {
...
public extension GetAccessKeyInfoResponseForGetAccessKeyInfo {
     ...
     */
    public static let __default: SecurityTokenModel.GetAccessKeyInfoResponseForGetAccessKeyInfo = {
